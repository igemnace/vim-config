...
" Original Author: Tim Pope <code@tpope.net>
" Copyright (c) Tim Pope. Distributed under the same terms as Vim itself. See
" `:help license`.
"
" Copied from https://github.com/tpope/vim-sexp-mappings-for-regular-people
" I simply set ONLY these normal mappings, instead of using g:sexp_filetypes
" (which sets all the vim-sexp mappings, including Meta keys)
...
function! s:setup() abort
  augroup sexp_mappings_for_regular_people
    autocmd!
    execute 'autocmd FileType' get(g:, 'sexp_normal_mapping_filetypes', 'lisp,scheme,clojure') 'call s:sexp_mappings()'
  augroup END
endfunction
