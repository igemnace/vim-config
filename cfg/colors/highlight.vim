...
highlight ColorColumn      cterm=NONE      ctermfg=NONE ctermbg=237  gui=NONE      guifg=NONE    guibg=#393939    guisp=NONE
highlight Conceal          cterm=NONE      ctermfg=4    ctermbg=0    gui=NONE      guifg=#6699cc guibg=#2d2d2d    guisp=NONE
highlight CursorColumn     cterm=NONE      ctermfg=NONE ctermbg=237  gui=NONE      guifg=NONE    guibg=#393939    guisp=NONE
...
highlight CursorLine       cterm=NONE      ctermfg=NONE ctermbg=237  gui=NONE      guifg=NONE    guibg=#393939    guisp=NONE
highlight Debug            cterm=NONE      ctermfg=1    ctermbg=NONE gui=NONE      guifg=#f2777a guibg=NONE       guisp=NONE
highlight DiffAdd          cterm=bold      ctermfg=2    ctermbg=237  gui=bold      guifg=#99cc99 guibg=#393939    guisp=NONE
highlight DiffChange       cterm=NONE      ctermfg=8    ctermbg=237  gui=NONE      guifg=#747369 guibg=#393939    guisp=NONE
highlight DiffDelete       cterm=NONE      ctermfg=1    ctermbg=237  gui=NONE      guifg=#f2777a guibg=#393939    guisp=NONE
highlight DiffText         cterm=bold      ctermfg=3    ctermbg=237  gui=bold      guifg=#6699cc guibg=#393939    guisp=NONE
...
highlight Folded           cterm=NONE      ctermfg=8    ctermbg=237  gui=NONE      guifg=#747369 guibg=#393939    guisp=NONE
highlight Ignore           cterm=NONE      ctermfg=0    ctermbg=NONE gui=NONE      guifg=bg      guibg=NONE       guisp=NONE
highlight IncSearch        cterm=NONE      ctermfg=237  ctermbg=8    gui=NONE      guifg=#393939 guibg=#f99157    guisp=NONE
...
highlight PmenuSel         cterm=NONE      ctermfg=3    ctermbg=237  gui=NONE      guifg=#393939 guibg=#a09f93    guisp=NONE
...
highlight Search           cterm=NONE      ctermfg=237  ctermbg=8    gui=NONE      guifg=#747369 guibg=#ffcc66    guisp=NONE
highlight SignColumn       cterm=NONE      ctermfg=237  ctermbg=0    gui=NONE      guifg=#747369 guibg=#393939    guisp=NONE
...
highlight StatusLineNC     cterm=NONE      ctermfg=8    ctermbg=237  gui=NONE      guifg=#747369 guibg=#393939    guisp=NONE
highlight StatusLine       cterm=NONE      ctermfg=8    ctermbg=237  gui=NONE      guifg=#a09f93 guibg=#515151    guisp=NONE
highlight StatusLineTermNC cterm=NONE      ctermfg=8    ctermbg=237  gui=NONE      guifg=bg      guibg=LightGreen guisp=NONE
highlight StatusLineTerm   cterm=NONE      ctermfg=8    ctermbg=237  gui=NONE      guifg=bg      guibg=LightGreen guisp=NONE
highlight TabLineFill      cterm=NONE      ctermfg=237  ctermbg=237  gui=NONE      guifg=#747369 guibg=#393939    guisp=NONE
highlight TabLineSel       cterm=NONE      ctermfg=3    ctermbg=237  gui=NONE      guifg=#99cc99 guibg=#393939    guisp=NONE
highlight TabLine          cterm=NONE      ctermfg=8    ctermbg=237  gui=NONE      guifg=#747369 guibg=#393939    guisp=NONE
...
highlight User2 cterm=NONE ctermfg=2 ctermbg=237gui=NONE guifg=NONE guibg=NONE guisp=NONE
highlight User3 cterm=NONE ctermfg=3 ctermbg=237gui=NONE guifg=NONE guibg=NONE guisp=NONE
highlight User4 cterm=NONE ctermfg=4 ctermbg=237gui=NONE guifg=NONE guibg=NONE guisp=NONE
